...
async def main(phone):
    ...
    #Getting just the last message
    latest_message_text = latest_message['message']
    
                          
                    
    #extracting relevant info from the message
    symbol = latest_message_text.split()[0]
    entry = float(deEmojify(latest_message_text.split()[3]))
    SL = float(deEmojify(latest_message_text.split()[5]))
    TP1 = float(deEmojify(latest_message_text.split()[7]))
    TP2 = float(deEmojify(latest_message_text.split()[9]))
    TP3 = float(deEmojify(latest_message_text.split()[11]))

    #sending the first trade - lowest TP
    my_trade1 = {}
    my_trade1['_action'] = 'OPEN'
    my_trade1['_type'] = orderTypeEncode(latest_message['message'].split()[1])
...
#     #sending the second trade - middle TP
#     my_trade2 = {}
#     my_trade2['_action'] = 'OPEN'
#     my_trade2['_type'] = orderTypeEncode(latest_message['message'].split()[1])
...
#     #sending the third trade - highest TP
#     my_trade3 = {}
#     my_trade3['_action'] = 'OPEN'
#     my_trade3['_type'] = orderTypeEncode(latest_message['message'].split()[1])
...
#     my_trade3['_ticket']= 0
    ...
    _zmq._DWX_MTX_NEW_TRADE_(_order=my_trade1)
#     _zmq._DWX_MTX_NEW_TRADE_(_order=my_trade2)                      
#     _zmq._DWX_MTX_NEW_TRADE_(_order=my_trade3)
